...
# ✅ Wymuszamy pobranie zasobów w katalogu aplikacji Streamlit Cloud
NLTK_DATA_PATH = os.path.join(os.getcwd(), "nltk_data")
os.makedirs(NLTK_DATA_PATH, exist_ok=True)
nltk.data.path.append(NLTK_DATA_PATH)

# ✅ Pobranie tokenizera przed użyciem (rozwiązuje błąd LookupError)
...
def evaluate_email(email_text, task_requirements):
    ...
    # ✅ Wymuszenie pobrania przed użyciem sent_tokenize

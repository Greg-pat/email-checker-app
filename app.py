...
# Narzędzie do sprawdzania języka (stabilniejsze połączenie)
...
if st.button("Sprawdź"):
    if len(email_text.split()) < 10:
        ...
        try:
            ...
            st.error("⛔ Wystąpił błąd podczas połączenia z narzędziem LanguageTool. Spróbuj ponownie za chwilę.")
